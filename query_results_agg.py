...
# MAGIC count_summons_number:long
# MAGIC count_no_stand_number:long
# MAGIC count_hydrant_violation_number:long
# MAGIC count_double_parking_violation_number:long
# MAGIC max_days_parking_in_effect_number:string
# MAGIC min_days_parking_in_effect_number:string
# MAGIC max_feet_from_curb_number:integer
# MAGIC min_feet_from_curb_number:integer
# MAGIC ***/
# MAGIC 
# MAGIC --Number of violation per month in 2017?
# MAGIC 
# MAGIC select count(count_summons_number), month
# MAGIC from dm_nyu_parking.agg_nyu_parking_violation_info
...
# MAGIC 
# MAGIC select count(count_summons_number) as frequency, violation_time
# MAGIC from dm_nyu_parking.agg_nyu_parking_violation_info
...
# MAGIC from dm_nyu_parking.agg_nyu_parking_violation_info a, dm_nyu_parking.dim_violation_location_info b
...
# MAGIC 
# MAGIC select count(count_summons_number), issuer_precinct
# MAGIC from dm_nyu_parking.agg_nyu_parking_violation_info a, dm_nyu_parking.dim_issuer_info b
